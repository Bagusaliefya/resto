<?php if (isset($addjenis)) : ?>
	<script>
		Swal.fire({
			...
			text: 'Data Jenis Berhasil di Tambahkan',
			icon: 'success',
...
<?php if (isset($addmenu)) : ?>
	<script>
		Swal.fire({
			title: 'Tambah Data Success!',
			text: 'Data Menu Berhasil di Tambahkan',
			icon: 'success',
			confirmButtonText: 'OK'
		}).then((result) => {
			if (result.value) {
...
<?php if (isset($upmenu)) : ?>
	<script>
		Swal.fire({
			title: 'Update Data Success!',
			text: 'Data Menu Berhasil di Ubah',
			icon: 'success',
			confirmButtonText: 'OK'
		}).then((result) => {
			if (result.value) {
...
<?php if (isset($addtransaksi)) : ?>
	<script>
		Swal.fire({
			title: 'Tambah Data Success!',
			text: 'Transaksi Pemesanan di Tambahkan',
			icon: 'success',
			confirmButtonText: 'OK'
		}).then((result) => {
			if (result.value) {
...
<?php if (isset($uptransaksi)) : ?>
	<script>
		Swal.fire({
			title: 'Ubah Data Success!',
			text: 'Transaksi Pemesanan di Ubah',
			icon: 'success',
			confirmButtonText: 'OK'
		}).then((result) => {
			if (result.value) {
...
<!-- order -->
<?php if (isset($addorder)) : ?>
	<script>
		Swal.fire({
			title: 'Tambah Data Success!',
			text: 'Order Pemesanan di Tambahkan',
			icon: 'success',
			confirmButtonText: 'OK'
		}).then((result) => {
			if (result.value) {
				window.location = 'index.php?halaman=order-order';
			}
		})
	</script>
<?php endif ?>
<?php if (isset($uporder)) : ?>
	<script>
		Swal.fire({
			title: 'Ubah Data Success!',
			text: 'Transaksi Pemesanan di Ubah',
