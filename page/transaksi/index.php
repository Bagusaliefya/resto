    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                ...
                <a href="transaksi-order.php" data-bs-toggle="modal" data-bs-target="#tambah" style="float: right;" class="btn btn-sm btn-primary">
                    Tambah Order
                </a>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <form method="post">
                                        ...
                                        <button onclick="return confirm('Yakin Hapus Data <?php echo $dt['no_transaksi'] ?>?')" name="hapus" class="btn btn-sm btn-danger rounded-pill"><i class="dripicons dripicons-trash"></i></button>
                                    </form>
                                </td>
                            </tr>
