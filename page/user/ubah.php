<div class="modal fade text-left" id="ubah<?php echo $dt['id_user'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="level">
                            <option <?php if ($dt['level'] == "Kasir") {
                                        echo "selected";
                                    } ?> value="Kasir">Kasir</option>
                            <option <?php if ($dt['level'] == "Admin") {
                                        echo "selected";
                                    } ?> value="Admin">Admin</option>
                            <option <?php if ($dt['level'] == "Owner") {
                                        echo "selected";
                                    } ?> value="Owner">Owner</option>
                            <option <?php if ($dt['level'] == "waiter") {
                                        echo "selected";
                                    } ?> value="Waiter">Waiter</option>
                        </select>
                    </div>
                </div>
